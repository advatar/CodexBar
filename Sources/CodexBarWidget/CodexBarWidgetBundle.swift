...
struct CodexBarSwitcherWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("TeamTokenBar Switcher")
...
struct CodexBarUsageWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("TeamTokenBar Usage")
...
struct CodexBarHistoryWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("TeamTokenBar History")
...
struct CodexBarCompactWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("TeamTokenBar Metric")
